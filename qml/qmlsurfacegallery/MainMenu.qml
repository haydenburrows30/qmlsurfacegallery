...
Page {
    ...
    ColumnLayout {
        ...
        Repeater {
            ...
            {name:"Multi Graph", url:"MultiGraph.qml", tooltip: "3D bar, surface and scatter plot"},
            {name:"Equation", url:"Equation.qml", tooltip: "Custom equation surface"},
            {name:"Custom Input", url:"CustomInput.qml", tooltip: "Scatter rotating chart"},
            {name:"Axis Dragging", url:"AxisDragging.qml", tooltip: "Scatter chart"},
